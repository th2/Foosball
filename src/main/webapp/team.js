...
function addTeam(){
	...
	if (newTeamName === '') {
		...
		sendToBackend('team/addTeam', 'name=' + encodeURI(newTeamName), function (data) {
...
function deleteTeam(teamId){
	...
	sendToBackend('team/deleteTeam', 'id=' + teamId.substring(4), function (data) {
...
function addPlayer(){
	...
	if (newPlayerName === '') {
		...
		sendToBackend('team/addPlayer', 'name=' + newPlayerName, function (data) {
...
function deletePlayer(playerId){
	for (var teamId in teams) {
		if (playerId in teams[teamId].players) {
			sendToBackend('team/deletePlayer', 'teamId=' + teamId.substring(4) +
...
function movePlayerToTeam(playerId, newTeamId) {
	for (var oldTeamId in teams) {
		if ((oldTeamId !== newTeamId) && (playerId in teams[oldTeamId].players)) {
			sendToBackend('team/movePlayer', 'oldTeamId=' + oldTeamId.substring(4) +
